# Winning Through Platforms — Sustainashare mapping

Reference framework: *Winning Through Platforms* (Ted Moser, Charlotte Bloom, Omar Akhtar) — portfolio, design, demand, innovation, interaction, and transformation plays. Sustainashare’s primary role: **trusted resource-redistribution orchestrator and impact-visibility platform**.

## Strategic advantage plays

| Play | Now / Next / Later / N/A | User value | Platform mechanism | Status | Success metric |
|------|--------------------------|------------|--------------------|--------|----------------|
...
## Interaction & transformation plays
...
- **Choose:** discovery → trust → role selection → registration → verification.
- **Use:** list/request → match → schedule → handover → confirm → impact → feedback → repeat.

Optimise for **completed verified donation journeys**, not registrations alone.
